...
{
    /// <inheritdoc />
    public partial class FeedbackMinerMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Themes_ProcessingRuns_ProcessingRunId",
                        column: x => x.ProcessingRunId,
                        principalTable: "ProcessingRuns",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Themes_ProcessingRunId",
                table: "Themes",
                column: "ProcessingRunId");
        }
